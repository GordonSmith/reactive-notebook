...
const notebook = {
  "cells": [
    ...
    {
      "id": 23,
      "value": "const resetButton = Inputs.button(\"Reset zoom\", { reduce: chart.reset });\n",
      "mode": "js",
      "pinned": false,
      "hidden": false
    },
    {
      "id": 24,
      "value": "const years = Inputs.range([1, 20], { value: 10, step: 1, label: \"Years\" });\n",
      "mode": "js",
      "pinned": false,
      "hidden": false
    },
    {
      "id": 25,
      "value": "const chart = Timeline(scaleX, margin, 240)",
      "mode": "js",
      "pinned": false,
      "hidden": true
    },
    ...
    {
      "id": 31,
      "value": "const days = getDays(...scaleX.domain())",
      "mode": "js",
      "pinned": false,
      "hidden": true
    },
    {
      "id": 32,
      "value": "const zoomScaleExtent = [1, Math.round(days)]",
      "mode": "js",
      "pinned": false,
      "hidden": true
    },
    {
      "id": 33,
      "value": "const margin = ({ top: 80, right: 20, bottom: 20, left: 20 });",
      "mode": "js",
      "pinned": false,
      "hidden": false
    },
    {
      "id": 34,
      "value": "const MS_PER_DAY = 24 * MS_PER_HOUR;",
      "mode": "js",
      "pinned": false,
      "hidden": false
    },
    {
      "id": 35,
      "value": "const MS_PER_HOUR = 60 * 60 * 1000;",
      "mode": "js",
      "pinned": false,
      "hidden": false
    },
    {
      "id": 36,
      "value": "const MS_PER_YEAR = 365.24 * MS_PER_DAY; // include leap year",
      "mode": "js",
      "pinned": false,
      "hidden": false
    },
