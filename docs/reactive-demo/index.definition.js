...
const resetButton = Inputs.button("Reset zoom", { reduce: chart.reset });
return {resetButton};

}
function cell_21(Inputs) {

const years = Inputs.range([1, 20], { value: 10, step: 1, label: "Years" });
return {years};

}
function cell_22(Timeline, scaleX, margin) {

const chart = Timeline(scaleX, margin, 240)
return {chart};
...
function cell_26(display, scaleX) {

return (
display(scaleX.domain())
)
...
const days = getDays(...scaleX.domain())
return {days};

}
function cell_29(days) {

const zoomScaleExtent = [1, Math.round(days)]
return {zoomScaleExtent};
